  ...
  <el-card class="category-list">
    <div slot="header">
      <el-row :gutter="20">
        ...
        <el-col :span="2" :offset="18"><div><el-button type="success" round size="medium" @click="goCategoryEdit">添加分类</el-button></div></el-col>
      </el-row>
    </div>
    <div class="content">
        ...
        <el-collapse-item :name="index" v-for="(category, index) in categoryData" :key="category.objectId">
          <template slot="title">
            <el-row :gutter="20">
              ...
              <el-col :span="2"><div><el-button size="mini" type="danger">删除</el-button></div></el-col>
            </el-row>
          </template>
          <el-table
